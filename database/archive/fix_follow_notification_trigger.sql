-- Fix follow notification trigger - 컬럼명 수정 및 중복 방지
...
BEGIN
  ...
  -- 알림 생성 (컬럼명 수정: followed_id → following_id)
  INSERT INTO notifications (
    ...
    NEW.following_id,  -- 수정: 팔로우당한 사람이 수신자
...
-- 확인용 쿼리
SELECT 'Follow notification trigger updated successfully' as status;